        ...
        <div class="container-lg">
            <div class="flex items-center">
                ...
                <div class="hidden sm:flex items-center">
                    <div class="uppercase tracking-wide text-sm font-semibold text-grey-dark mr-3">
                        share
                    </div>
                    <a 
                        class="block border-0 leading-tight text-grey-dark hover:text-blue-light mr-2"
                        href="https://twitter.com/share?text=ENCODED_TITLE&amp;url=ABSOLUTE_URL"
                    ...
                    <a
                        class="block border-0 leading-tight text-grey-dark hover:text-blue-dark"
                        href="https://www.facebook.com/sharer/sharer.php?u=ABSOLUTE_URL"
